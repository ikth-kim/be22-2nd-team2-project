...
import com.team2.nextpage.websocket.dto.CommentCreatedEvent;
...
public class ReactionController {
  ...
  public ResponseEntity<ApiResponse<Long>> createComment(
    ...
    String nickname = memberRepository.findById(userId)
        .map(com.team2.nextpage.command.member.entity.Member::getUserNicknm)
        .orElse("알수없음");
