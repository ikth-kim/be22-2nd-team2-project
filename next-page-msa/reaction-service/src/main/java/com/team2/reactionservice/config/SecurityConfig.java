package com.team2.reactionservice.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 댓글/좋아요 조회 API - GET 요청만 누구나 접근 가능
                        .requestMatchers(HttpMethod.GET, "/api/reactions/comments/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/reactions/likes/**").permitAll()
